...
contract('Futarchy', (accounts) => {
  ...
  describe('tradeInMarkets()', async () => {
    ...
    it('creates a new TradePorfolio for each unique trader', async () => {
      ...
      await futarchy.tradeInMarkets(0, twenty, [five, 0], [0, five], {from: root})
      ...
      await futarchy.tradeInMarkets(0, twenty, [three, 0], [0, three], {from: account2})
    ...
    describe('when trader is trading again on the same market', async () => {
      beforeEach(async () => {
        ...
        await futarchy.tradeInMarkets(0, twenty, [five, 0], [0, five])
      })
      ...
      it('records the correct data in the existing OutcomeTokenBalances for the trader', async () => {
        ...
        await futarchy.tradeInMarkets(0, twenty, [three, 0], [0, five])
    ...
    describe('for yesMarket trades', async () => {
      ...
      describe('when yesPrediction is 1 (short)', async () => {
        beforeEach(async () => {
          await futarchy.tradeInMarkets(0, twenty, [0, five], [0, five])
        })
    ...
    describe('for noMarket trades', async () => {
      ...
      describe('when noPrediction is 0 (long)', async () => {
        ...
        beforeEach(async () => {
          await futarchy.tradeInMarkets(0, twenty, [0, five], [five, 0])
        })
